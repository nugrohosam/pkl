...
instalasi.post('/save', async (req, res) => {
    ...
    var id_bidangtanggal = data.id_bidang
    ...
    try{
        ...
        sql = 'INSERT INTO instalasi (id_instalasi, nama_instalasi ) VALUES (\''+id_instalasi+'\', \''+nama_instalasi+'\', \''+id_bidang+'\', \''+buat_pada+'\', \''+ubah_pada+'\')';
...
instalasi.post('/update/:id', async (req, res) => {
    ...
    try{
        ...
        sql = 'UPDATE instalasi SET nama_instalasi = \''+nama_instalasi+'\', id_bidang =  \''+id_bidang+'\' WHERE id_instalasi = \''+id_instalasi+'\' AND dikerjakan is null AND diterima is not null';
        await dbconn.query(sql)
